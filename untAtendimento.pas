...
procedure TfrmAtendimento.AdicionarHora();
var
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Cells[4,i]:= atendimento.descricao;
...
begin
  if Arow > 0 then
  begin
    if sgridHorarios.Cells[5,ARow] = 'NÃO'
      then sgridHorarios.Canvas.Brush.color := clPaleGreen
    else
    if sgridHorarios.Cells[5,ARow] = 'SIM'
